...
class ScoreControllerTest {
    ...
    /**
     * updating own score in DB to send on client
     *
     * @throws JSONException org.json. j s o n exception
     */
    @Test
    void up() throws JSONException {
        try {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("балл",1L);
            this.mockMvc.perform(MockMvcRequestBuilders.post("http://localhost:8081/updatescore")
